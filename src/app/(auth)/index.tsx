        ...
        <View className="w-full mt-4 px-4 flex-1 justify-center gap-8">
            ...
            <View className="flex gap-6">
                ...
                <View className="flex-row gap-2">
                    <Text className="text-white items-center">Não possui conta?</Text>
                    <Pressable><Text className="text-[#00b030]" onPress={() => router.push("/register")}>Criar conta</Text></Pressable>
                </View>
            </View>
        </View>
