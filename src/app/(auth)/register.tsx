...
import { registerRequest } from "@/src/http/auth";
import { router } from "expo-router";
import { useState } from "react";
import { Pressable, View, Text, Image, TextInput, Alert, ActivityIndicator } from "react-native";
...
export default function Register() {
  ...
  return (
    ...
    <View className="w-full mt-4 px-4 flex-1 justify-center gap-8">
        ...
        <Text className="text-text font-bold text-2xl text-center">Registro</Text>
